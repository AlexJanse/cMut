...
The following functions (can) search for patterns that match with the mutations (clusters). If no pattern table is sent through the parameters, the default is used:
```{r echo = FALSE}
