...
```{r include = T}
linkPatterns(ref = "A", alt = "G", context = "TA.T", distance = 550)
linkPatterns(ref = "A", alt = "G", context = "TA.T", distance = 50)
```
...
groups[groups$has.intersect,"foundPatterns"][[1]]
```
...
# Because multiple patterns might matched the results, the patterns are put into a list.
groups[groups$has.clusterPatterns,"foundPatterns"][[1]]
```
